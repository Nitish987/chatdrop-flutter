...
class Search extends StatelessWidget {
  const Search({Key? key, this.height = 300, this.padding = const EdgeInsets.all(20), this.margin = const EdgeInsets.all(0), this.label = 'Search something else.'}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String assetSource = theme == ThemeState.light ? IllustrationAssets.searchLight : IllustrationAssets.searchDark;
