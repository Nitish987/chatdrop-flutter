...
class Nothing extends StatelessWidget {
  const Nothing({Key? key, this.height = 300,  this.padding = const EdgeInsets.all(20), this.margin = const EdgeInsets.all(0), this.label = 'Nothing to show.'}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String assetSource = theme == ThemeState.light ? IllustrationAssets.nothingLight : IllustrationAssets.nothingDark;
