...
class Chats extends StatelessWidget {
  const Chats({Key? key, this.height = 250, this.padding = const EdgeInsets.all(20), this.margin = const EdgeInsets.all(0), this.label = 'No chats are there.'}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String assetSource = theme == ThemeState.light ? IllustrationAssets.chatsLight : IllustrationAssets.chatsDark;
